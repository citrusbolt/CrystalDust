const u8 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_PKMN_BREEDER_F] = TRAINER_PIC_JUGGLER,
    [FACILITY_CLASS_COOLTRAINER_M] = TRAINER_PIC_COOLTRAINER_M,
    [FACILITY_CLASS_BIRD_KEEPER] = TRAINER_PIC_BIRD_KEEPER,
    [FACILITY_CLASS_COLLECTOR] = TRAINER_PIC_SAGE,
    [FACILITY_CLASS_AQUA_GRUNT_F] = TRAINER_PIC_ROCKET_GRUNT_F,
    [FACILITY_CLASS_SWIMMER_M] = TRAINER_PIC_SWIMMER_M,
    [FACILITY_CLASS_MAGMA_GRUNT_M] = TRAINER_PIC_SUPER_NERD,
    [FACILITY_CLASS_EXPERT_M] = TRAINER_PIC_FIREBREATHER,
    ...
    [FACILITY_CLASS_INTERVIEWER] = TRAINER_PIC_OFFICER,
    ...
    [FACILITY_CLASS_LEADER_ROXANNE] = TRAINER_PIC_LEADER_FALKNER,
    ...
    [FACILITY_CLASS_RIVAL] = TRAINER_PIC_RIVAL,
    [FACILITY_CLASS_GOLD] = TRAINER_PIC_GOLD,
    [FACILITY_CLASS_BRENDAN_2] = TRAINER_PIC_EM_BRENDAN,
    [FACILITY_CLASS_BRENDAN_3] = TRAINER_PIC_EM_BRENDAN,
    [FACILITY_CLASS_KRIS] = TRAINER_PIC_KRIS,
    [FACILITY_CLASS_MAY_2] = TRAINER_PIC_EM_MAY,
    [FACILITY_CLASS_MAY_3] = TRAINER_PIC_EM_MAY,
...
const u8 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_AQUA_GRUNT_M] = TRAINER_CLASS_TEAM_ROCKET,
    [FACILITY_CLASS_PKMN_BREEDER_F] = TRAINER_CLASS_JUGGLER,
    [FACILITY_CLASS_COOLTRAINER_M] = TRAINER_CLASS_COOLTRAINER,
    [FACILITY_CLASS_BIRD_KEEPER] = TRAINER_CLASS_BIRD_KEEPER,
    [FACILITY_CLASS_COLLECTOR] = TRAINER_CLASS_SAGE,
    [FACILITY_CLASS_AQUA_GRUNT_F] = TRAINER_CLASS_TEAM_ROCKET,
    [FACILITY_CLASS_SWIMMER_M] = TRAINER_CLASS_SWIMMER_M,
    [FACILITY_CLASS_MAGMA_GRUNT_M] = TRAINER_CLASS_SUPER_NERD,
    [FACILITY_CLASS_EXPERT_M] = TRAINER_CLASS_FIREBREATHER,
    ...
    [FACILITY_CLASS_INTERVIEWER] = TRAINER_CLASS_OFFICER,
    ...
    [FACILITY_CLASS_EXPERT_F] = TRAINER_CLASS_FIREBREATHER,
    [FACILITY_CLASS_POKEMANIAC] = TRAINER_CLASS_POKEMANIAC,
    [FACILITY_CLASS_MAGMA_GRUNT_F] = TRAINER_CLASS_SUPER_NERD,
    ...
    [FACILITY_CLASS_RIVAL] = TRAINER_CLASS_PKMN_TRAINER_3,
    ...
    [FACILITY_CLASS_PKMN_BREEDER_M] = TRAINER_CLASS_JUGGLER,
    ...
    [FACILITY_CLASS_EM_BRENDAN] = TRAINER_CLASS_PKMN_TRAINER_3,
    [FACILITY_CLASS_EM_MAY] = TRAINER_CLASS_PKMN_TRAINER_3,
